            ...
            <div class="col-lg-12">
                <div class="bread-crumb-area-inner">
                    <div class="breadcrumb-top">
                        ...
                        <a class="active" href="ospitalita.html">Ospitalità</a>
                    </div>
                    <div class="bottom-title">
                        <h1 class="title">Ospitalità</h1>
                        <a href="javascript:;" class="rts-btn btn-primary">Prenota ora</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 mt_md--50 mt_sm--50">
                ...
                <div class="row gallery mt--40 mb--40">
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/villa/1.jpg">
                            <img src="assets/images/villa/1.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/villa/2.jpg">
                            <img src="assets/images/villa/2.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/villa/3.jpg">
                            <img src="assets/images/villa/3.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                    ...
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/villa/5.jpg">
                            <img src="assets/images/villa/5.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/villa/6.jpg">
                            <img src="assets/images/villa/6.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/villa/7.jpg">
                            <img src="assets/images/villa/7.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                    ...
                    <div class="row product-details-right-one">
                        <div class="col-md-12">
                            ...
                            <p class="disc">
                                ...
                                <b>Appartamento "Trebbiano"</b>: Un salone con travi a vista con accesso indipendente e cucina separata. Una camera da letto matrimoniale e una camera da letto doppia (2 letti singoli o 1 letto matrimoniale), entrambe con bagno privato. Un'esclusiva terrazza panoramica con vista su Rocca di Papa.<br><br>
                ...
                <div class="row gallery mt--40 mb--40">
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/casa/1.jpg">
                            <img src="assets/images/casa/1.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/casa/2.jpg">
                            <img src="assets/images/casa/2.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/casa/3.jpg">
                            <img src="assets/images/casa/3.jpg">
                        </a>
                    </div>
                    <div class="col-md-3 col-6 mbot-20">
                        <a href="assets/images/casa/4.jpg">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="title-main-s">Servizi inclusi</h3>
                        <ul>
                            <li>Accesso alla piscina (non riscaldata, illuminazione notturna)</li>
                            <li>Parcheggio</li>
                            <li>WIFI (negli spazi interni e a bordo piscina)</li>
                            <li>Pulizia finale</li>
                            <li>Cambio asciugamani una volta a settimana</li>
                            <li>Shampoo, sapone</li>
