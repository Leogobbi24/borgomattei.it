                ...
                <div class="rts-banner-area-start-one pb--100 ptb_sm--140">
                    ...
                    <div class="left-swiper-area-start">
                        ...
                        <div class="single-left-banner-swiper-start">
                            <h2 class="title">Benvenuti a Borgo Mattei</h2>
                            <p class="disc">
                                Il cuore di  Tenuta Sant’Anna nel Parco dei Castelli Romani a pochi passi da Roma.
                            </p>
                            <div class="animation-55"><a href="product-details-1.html" class="rts-btn btn-border">Ospitalità</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="our-working-process rts-section-gap" style="padding-top:0px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="title-process-stock-text">
                    <h2 class="stock-text-1 title-large-3 end">SERVIZI & ATTIVITA'</h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title-area-product-one">
                    ...
                    <p class="disc">
                        Our interior design project revolves around transforming a residential space into a modern and inviting oasis. With a focus on functionality and aesthetics, our team of talented designers will collaborate closely.
                    </p>
